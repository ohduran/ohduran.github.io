...
Of course, I didn't understand the book the first time I read it. But that's because reading, as we learned in [How to Read a Book](/how-to-read-a-book), doesn't end there. I'm still reading it now, by writing.

## Introduction by Betrand Russell

Let's go over the introduction to see how much can we get out of the book before even reading it, but by looking at how Mr Russell summarised its key ideas:
...
In a logically perfect language, however, nothing that is not simple will have a simple symbol, but a complex containing the symbols for the parts.
