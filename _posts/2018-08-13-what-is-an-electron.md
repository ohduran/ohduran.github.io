...
How do we handle complex ideas in our head? How do we manage to use a brain that, in all its power, was designed to grasp concrete ideas to hunt, organise small groups of people and preserve itself, and put it to manipulate concepts that cannot be seen?

At the peak of their era, Romans have conquered pretty much all the known world, and yet they were using a numerical system that could only count up to 10,000, and the concept of zero was yet to be mastered! If we are to trust that Nature knows better, that evolution dealt with a tremendous amount of trade-offs to bring us here, then as a species we did without complex mathematical ideas for the first 90 % of our existence. Ideas that we are, at best, unprepared to deal with. One of those such ideas is Quantum Mechanics.

As an advanced society, we still believe that electrons are small planets orbiting around the core of the atom, with defined paths, with clear trajectories and that is, given what we know about electricity, impossible. An atom doing that isn't stable, and it would collapse in the blink of an eye, as the electron, orbiting around, would beam up electricity and collapsing into the core in an spectacular fashion.
...
Here is the part that gets tricky, where the analogies do not apply. Where all the magic happens.
...
Now comes the hard part: does this hold in experiments? Is this consistent with what the scientific community has seen in experiments? In fact, it is indeed. An electron is both a particle, because trying to experiment with it releases all properties that can be attached to a particle (you can trace its charge when using drops of oil, like Milikan did). At the same time, you can never tell with absolute certainty where an electron is, given the fact that the energy is always discrete, that is, it "jumps" from one state to the next without going "inbetween". These and more leave us in an impossible middle ground between particle and wave that physicists still try to get their heads around nowadays.
