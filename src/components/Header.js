    ...
    return (
      <>
        ...
        >
          ...
          <nav className="col-start-2 mt-4 mr-2 text-nord-4 text-right font-semibold font-family-baloo flex justify-center">
            <Link to="/essays">Ensayos</Link>
            <Link className="ml-2" to="/newsletter">
              Newsletter
            </Link>
          </nav>
        </header>
