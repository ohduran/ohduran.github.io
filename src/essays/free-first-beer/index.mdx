...
Yes. Software can be sold. This is beyond the point of realising that someone can be trusted with "not sharing it with no one else". As if it were a secret. The same rule apply: if you didn't keep it, why on Earth is anyone else going to?
