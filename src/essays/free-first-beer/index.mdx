...
Ah, but there's an obvious point to be made: software isn't physical. It's not _stuff_, in the sense that there are no limits to your ability to copy paste it endlessly<sup>1</sup>. <p class="sidenote"><sup>1</sup> Thanks <a href="https://en.wikipedia.org/wiki/Larry_Tesler">Larry Tesler</a>.</p>
...
Non-physical properties do not operate under that paradigm.
...
or [Facebook](https://opensource.facebook.com/projects), or even [Microsoft](https://www.techrepublic.com/article/why-microsoft-and-google-are-now-leading-the-open-source-revolution/)<sup>2</sup>. <p class="sidenote"><sup>2</sup> Of all places!</p>
...
Everything is free. Free as in "you don't pay anything upfront". But not "free as in 'free beer'". What I want you to think about is that those companies in the business of giving you things for free
so that you see ads are the ones most eager to share open source tools, contribute to projects that are meant to be free, and commoditize products that used to have more straightforward, pay-and-collect business models.
Everything is free in the Internet because we have been taught into thinking that the only appropriate business model online is selling ads.
